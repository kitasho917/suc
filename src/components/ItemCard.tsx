        ...
        <div className="flex-1">
          {isEditing ? (
            <div className="space-y-2">
              ...
              <select value={timeBlock} onChange={(e) => setTimeBlock(e.target.value as PlannerItem["timeBlock"])} className="w-full rounded border border-gray-200 p-2 text-sm">{timeBlocks.map((tb) => <option key={tb} value={tb}>時間帯: {timeBlockLabelMap[tb]}</option>)}</select>
